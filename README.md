...
6. Run `make install` to start the installation
...
Check out the [zshrc.zsh](https://github.com/jeffreydavidson/dotfiles/blob/master/zshrc.zsh) file and add your own aliases. If you need to tweak your `$PATH` check out the same file. You can adjust the [.zshrc](https://github.com/jeffreydavidson/dotfiles/blob/master/.zshrc) file to your liking.
